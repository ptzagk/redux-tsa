...
export default function skurt<T1, T2, T3, T4, T5, T6, T7, T8> (test: (val: T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8) => boolean):
    (n: number) => (ps: Iterable<
        T1 |
        PromiseLike<T1> |
        T2 |
...
export default function skurt<T1, T2, T3, T4, T5, T6, T7, T8, T9>(test: (val: T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9) => boolean):
    (n: number) => (ps: Iterable<
        T1 |
        PromiseLike<T1> |
        T2 |
...
export default function skurt<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(test: (val: T1 | T2 | T3 | T4 | T5| T6 | T7 | T8 | T9 | T10) => boolean) {
    ...
    return Promise.race([
        runSkurt(test, n, ps),
        Promise.all<T1 | T2 | T3 | T4 | T5| T6 | T7 | T8 | T9 | T10>(ps)
